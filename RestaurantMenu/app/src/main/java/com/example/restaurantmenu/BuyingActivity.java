    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(view -> {
            if (Integer.parseInt(input.getText().toString()) == 0) {
                ...
                resultIntent.putExtra("price", price * Integer.parseInt(input.getText().toString()));
                resultIntent.putExtra("quantity", input.getText().toString());
        ...
        btnBack.setOnClickListener(view -> {
            Intent intentBack = new Intent(BuyingActivity.this, CategoryActivity.class);
            intentBack.putExtra("category", getIntent().getStringExtra("category"));
